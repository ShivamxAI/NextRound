...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8000/api/profile/init", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) throw new Error("Failed to create profile in database");
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Get started with NextRound for free</CardDescription>
          </CardHeader>
